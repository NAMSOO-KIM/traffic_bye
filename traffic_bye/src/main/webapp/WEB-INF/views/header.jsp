							...
							<div class="menu-left">
								...
								<div class="brand-logo">
									...
									<a href="${contextPath}"><img
										src="${contextPath}/resources/assets/images/icon/logos.png"
												...
												<li>
													<div class="container">
														<div class="row">
																	...
																	<div class="menu-content">
																		<ul>
																			...
																			<li><a href="vegetables.html">qty. counter <i
																					class="fa fa-bolt icon-trend" aria-hidden="true"></i></a>
																			</li>
																...
																<div class="link-section">
																	...
																	<div class="menu-content">
																		<ul>
																			...
																			<li><a href="furniture-3.html">black friday</a></li>
																			<li><a href="fashion-4.html">cyber monday</a></li>
																	...
																	<div class="menu-content">
																		<ul>
																			<li><a href="index.html">bottom<i
																					class="ms-2 fa fa-bolt icon-trend"
																					aria-hidden="true"></i></a></li>
																			<li><a href="fashion-4.html">bottom left</a></li>
																			<li><a href="bicycle.html">bottom right</a></li>
																		</ul>
																	</div>
															...
															<div class="col mega-box">
																<div class="link-section">
																	...
																	<div class="menu-content">
																		<ul>
																			<li><a href="elements.html"> elements page<i
																					class="ms-2 fa fa-bolt icon-trend"
																					aria-hidden="true"></i>
																			</a></li>
																		</ul>
														...
														<div class="row">
															<div class="col-12">
																<img
																	src="${contextPath}/resources/assets/images/menu-banner.jpg"
										...
										<li><a href="#">식품</a>
											<ul>
												...
												<li><a href="category-page(no-sidebar).html">no
														sidebar</a></li>
												<li><a href="category-page(sidebar-popup).html">sidebar
														popup</a></li>
												<li><a href="category-page(metro).html">metro</a></li>
												<li><a href="category-page(full-width).html">full
														width</a></li>
										...
										<li class="onhover-div mobile-cart">
											<div>
												<img
													...
													class="img-fluid blur-up lazyload" alt=""> <i
													class="ti-shopping-cart"></i>
											</div> <span class="cart_qty_cls">2</span>
											<ul class="show-div shopping-cart">
												...
												<li>
													<div class="buttons">
														<a href="cart.html" class="view-cart">view cart</a> <a
