	...
	jQuery(function($) {
	    ...
	    $('#filterText').keyup(function(event) {
	        ...
	        if (val == "") {
	            ...
	            $('#product-grid-box').show();
	            
	            // $('.product-detail h6').show();
	        } else {
	            /*
	        	$('.product-detail h6').hide();
	            $(".product-detail h6:contains('"+val+"')").show();
	            */
	        	$('#product-grid-box').hide();
	        	$("#product-grid-box h6:contains('"+val+"')").show();
                                    ...
                                    <div class="collection-product-wrapper">
                                        ...
                                        <div class="product-wrapper-grid">
                                            ...
                                            <!-- 상품 입력 부분 -->
                                                ...
                                                <div class="col-xl-3 col-6 col-grid-box" id="product-grid-box">
