            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="theme-card">
                        <form class="theme-form" action="${contextPath}/member" method="post" id="registerForm">
                            ...
                            <div class="form-row row">
                                <div class="col-md-6">
                                    ...
                                    <input type="date" class="form-control" id="birth" placeholder="생년월일을 입력하세요"
                            ...
                            <div class="form-row row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="passport" placeholder="여권 번호를 입력하세요"
                            ...
                            <div class="form-row row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="card" placeholder="카드 번호를 입력하세요"
                                ...
                                <div class="col-md-6">
                                    <label for="cardExpire">유효기간</label>
                                    <input type="text" class="form-control" id="cardExpire" placeholder="유효기간을 입력하세요"
                                        required="required" name="cardExpire">
                                </div>
                                <div><input type="submit" class="btn btn-solid w-auto" value="가입하기" /></div>
                            </div>
                        </form>
                    </div>
                </div>
