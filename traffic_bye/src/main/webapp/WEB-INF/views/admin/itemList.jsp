...
<head>
    ...
    <!-- jsgrid css-->
    <link rel="stylesheet" type="text/css" href="${contextPath}/resources/assets/css/vendors/jsgrid.css">
...
<!-- Jsgrid js-->
<script src="${contextPath}/resources/assets/js/jsgrid/jsgrid.min.js"></script>
<script src="${contextPath}/resources/assets/js/jsgrid/griddata-productlist-digital.js"></script>
<script src="${contextPath}/resources/assets/js/jsgrid/jsgrid-list.js"></script>
